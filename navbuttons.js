...
function checkPasscode() {
  ...
  if(code === "100") {
    parent.postMessage({ action: 'changeSrc', newSrc: '100/index.html' }, 'luminafields.com');
  }
  if(code === "587112349") {
    parent.postMessage({ action: 'changeSrc', newSrc: 'nations/book.html' }, 'luminafields.com');
  }
}
